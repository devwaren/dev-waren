...
export default function GetInTouch() {
	return (
		<section className="relative overflow-hidden border-t border-gray-200 py-20">
			{/* Subtle background glow */}
			<div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gray-200/70 blur-3xl" />
			...
			<div className="relative flex flex-col justify-between gap-10 md:flex-row md:items-end">
				...
				<div className="relative">
					...
					<Link
						to="/get-in-touch"
						className="relative group inline-flex w-fit items-center gap-3 rounded-full bg-gray-900 px-6 py-3.5 text-sm font-medium text-white transition-all duration-300 hover:bg-gray-700"
					>
						Get in touch
						<MoveRight
							size={18}
